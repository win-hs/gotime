...
- **颱風與警特報**：有颱風接近或縣市發布特報時，頂端出現紅色提醒，並可在地圖上看到
  颱風的過去路徑、預報路徑、七級／十級風暴風圈與 70% 機率範圍；平常不佔版面
...
js/radar.js      雷達回波（重投影＋去背）
js/observe.js    自動氣象站即時觀測
js/alert.js      颱風路徑、颱風警報與縣市天氣特報
